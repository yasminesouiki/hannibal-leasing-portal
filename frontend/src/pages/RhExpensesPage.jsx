...
const RhExpensesPage = () => {
  const { status } = useParams();

  if (!VALID_STATUSES.includes(status)) {
    return <Navigate to="/rh/expenses/pending" replace />;
  }
  ...
  return (
    <div className="admin-expenses-page">
      ...
      <AdminExpensesList status={status} readOnly />
    </div>
  );
};

export default RhExpensesPage;
